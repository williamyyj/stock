...
public class TA4JDCAStrategy extends TA4JStrategy {
    ...
    private int period; // 周期 5週 20月 55 季
    ...
    private void proc_buy_strategy(int i) {
        ...
        double currcash = shareholding*shareavg+sharecash;
         if( (pvshareholding/currcash) < buyRatio && sharecash>0){
            ...
            System.out.println("before :"+total+"-->"+pvshareholding+","+sharecash+","+shareholding+","+shareavg);
            ...
            pvshareholding = Math.floor(shareholding * close.getValue(i).doubleValue()); 
            System.out.println("after  :"+total+"-->"+pvshareholding+","+sharecash+","+shareholding+","+shareavg);
        } 
    ...
    public void show() {
        ...
        System.out.println("總期數:" + term+",持股:"+this.shareholding+",均價:"+shareavg);
